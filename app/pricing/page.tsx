...
const tiers = [
  ...
  },
  {
    ...
    examples: [
      "Assignment brief + lecture slides",
    ...
    <main className="bg-[#f6f3ee] min-h-screen pt-24 pb-24 text-[#141210]">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <p className="text-sm text-[#7a7469] text-center leading-relaxed">
          ...
          <a
            href="/disclaimer"
            className="text-[#141210] hover:text-[#22c55e] border-b border-[#ddd9d0] hover:border-[#22c55e] transition-colors duration-150"
          >
            Read disclaimer →
          </a>
        </p>
